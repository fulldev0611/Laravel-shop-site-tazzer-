$(function ($) {
  ...
  $(document).ready(function () {
    ...
    // LOGIN FORM ENDS
    document.getElementById("email_login").value = localStorage.getItem('email_login');
        ...
        success: function (data) {
          if ((data.errors)) {
            ...
            if (data == 1) {
              ...
              if (data = "redirect") {window.location.href="https://tazzershop.azurewebsites.net/user/login"}
