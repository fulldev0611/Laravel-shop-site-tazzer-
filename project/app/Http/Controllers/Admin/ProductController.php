...
class ProductController extends Controller
{
    ...
    public function createDigital()
    {
        ...
        $sign = Currency::where('is_default','=',1)->first();
        $brands = Partner::all();
        return view('admin.product.create.digital',compact('cats','sign', 'brands'));
    }
    ...
    public function createLicense()
    {
        ...
        $sign = Currency::where('is_default','=',1)->first();
        $brands = Partner::all();
        return view('admin.product.create.license',compact('cats','sign', 'brands'));
    }
...
//                $input['childcategory_id'] = $request->childcategory_id;
    ...
    public function edit($id)
    {
        ...
        elseif($data->type == 'License')
            return view('admin.product.edit.license',compact('cats','data','sign','brands'));
        else
