...
public function index(Request $request)
{
    ...
    $women_products = Product::where('subcategory_id','=',19)->orwhere('childcategory_id','=',18)->orwhere('childcategory_id','=',19)->orwhere('childcategory_id','=',21)->orwhere('childcategory_id','=',23)->when($gs->affilate_product == 0,
    function($q){
        return $q->where('product_type','=', 'normal');
    })->orderBy('id','desc')->take(4)->get();
    $man_products = Product::where('subcategory_id','=',18)->orwhere('childcategory_id','=',17)->orwhere('childcategory_id','=',20)->orwhere('childcategory_id','=',22)->orwhere('childcategory_id','=',24)->when($gs->affilate_product == 0,
    function($q){
        return $q->where('product_type','=', 'normal');
    })->orderBy('id','desc')->take(4)->get();
    $electronics_products = Product::where('category_id','=',4)->when($gs->affilate_product == 0,
    function($q){
        return $q->where('product_type','=', 'normal');
    })->orderBy('id','desc')->take(4)->get();
    $ps = DB::table('pagesettings')->find(1);

    return view('front.index',compact('ps','sliders','services','top_small_banners','feature_products','women_products','man_products','electronics_products'));
}
...
public function extraIndex()
{
    ...
    $discount_products =  Product::where('is_discount','=',1)->where('status','=',1)->when($gs->affilate_product == 1,
    function($q){
        return $q->where('product_type','=', 'normal');
    })->orderBy('id','desc')->take(8)->get();
    ...
    public function subscribe(Request $request)
    {
        ...
        return response()->json(array('errors' => [ 0 =>  'This Email Has Already Been Taken.']));
          ...
          if(filter_var($request->email, FILTER_VALIDATE_EMAIL)) {
            ...
            return response()->json(array('errors' => ['Invalid Email Address.']));
          }    
        }
