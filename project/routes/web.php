...
Route::prefix("user")->group(function ()
{
  ...
  Route::get("/reset_password/{token}", "User\ForgotController@showResetPasswordForm")->name("user-newPassword");
  Route::post("/reset_password", "User\ForgotController@submitResetPassword")->name("user-newPassword-submit");
...
Route::group(["middleware" => "maintenance"], function ()
{
  ...
  //DISCOUNT PAGE
  Route::get("/discount/category/{category?}/{subcategory?}/{childcategory?}", "Front\CatalogController@discount_Category")->name("front.discount_Category");
  //DISCOUNT PAGE ENDS
  //BRAND PAGE
  Route::get("/brand/{brand_name?}", "Front\CatalogController@brand_category")->name("front.brand_Category");
  //BRAND PAGE ENDS
  // TAG SECTION
  ...
  Route::post("/order-track", "Front\CheckoutController@order");
