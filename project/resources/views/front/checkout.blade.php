...
{{--													</select>--}}
													<select name="customer_country" class="countries form-control" id="countryId" required>
										...
										<div class="order-area">
											...
											<div class="order-item">
												<div class="product-img">
													<div class="d-flex">
														<img id="product-img" src=" {{ asset('assets/images/products/'.$product['item']['photo']) }}"
															height="80" width="80" class="p-1">
													</div>
												</div>
												<div class="product-content">
													<p class="name">
														<a id="product-content" href="{{ route('front.product', $product['item']['slug']) }}"
													...
													<div class="quantity">
														...
														<span id="qttotal" class="qttotal">{{ $product['qty'] }} </span>
													</div>
...
// Step 2 btn DONE
	...
	$('#step3-btn').on('click',function(){
		...
		var productImg = $('#product-img').attr('src');
		var productContent = $('#product-content').text();
		var qtTotal = $('#qttotal').text();
		...
		$.ajax({
			type: "POST",
			url: mainurl + "/order-track",
			data: {email: email, total: total, productImg: productImg, productContent: productContent, qtTotal, qtTotal},
			success:function(data){
				// if(data == 0)
				// {
				// 	toastr.error('Insufficient Amount!');
