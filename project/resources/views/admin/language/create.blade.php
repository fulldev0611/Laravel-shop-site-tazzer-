            ...
            <div class="row">
                <div class="col-lg-12">
                    <h4 class="heading">{{ __('Add Language') }} <a class="add-btn"
                            href="{{ route('admin-lang-index') }}"><i class="fas fa-arrow-left"></i>
                            {{ __('Back') }}</a>
                    </h4>
                    <ul class="links">
                        <li>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        <input type="text" class="input-field" name="language"
                                            placeholder="{{ __('English') }}" required="" value="English">
                                    </div>
                                </div>
                                        ...
                                        <div class="tab-content py-3 px-3 px-sm-0" id="nav-tabContent">
                                            ...
                                            <div class="tab-pane fade show active" id="nav-home" role="tabpanel"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang16"
                                                            placeholder="Track Order" required="" value="Track Order">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang11"
                                                            placeholder="My Account" required="" value="My Account">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang221"
                                                            placeholder="User Panel" required="" value="User Panel">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang222"
                                                            placeholder="Profile" required="" value="Vendor Panel">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang223"
                                                            placeholder="Logout" required="" value="Logout">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang12"
                                                            placeholder="Sign in" required="" value="Sign in">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang13"
                                                            placeholder="Join" required="" value="Join">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang220"
                                                            placeholder="Sell" required="" value="Sell">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang831"
                                                            placeholder="Featured Links" required="" value="Featured Links">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang1"
                                                            placeholder="All Categories" required="" value="All Categories">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang3"
                                                            placeholder="Cart" required="" value="Cart">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang4"
                                                            placeholder="Item(s)" required="" value="Item(s)">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang5"
                                                            placeholder="View Cart" required="" value="View Cart">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang6"
                                                            placeholder="Total " required="" value="Total">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang7"
                                                            placeholder="Checkout" required="" value="Checkout">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang8"
                                                            placeholder="Cart is empty." required="" value="Cart is empty.">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang9"
                                                            placeholder="Wish" required="" value="Wish">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang10"
                                                            placeholder="Compare" required="" value="Compare">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang14"
                                                            placeholder="Categories" required="" value="Categories">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang17"
                                                            placeholder="Home" required="" value="Home">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang18"
                                                            placeholder="Blog" required="" value="Blog">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang19"
                                                            placeholder="Faq" required="" value="Faq">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang20"
                                                            placeholder="Contact Us" required="" value="Contact Us">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang25"
                                                            placeholder="Shop Now" required="" value="Shop Now">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang26"
                                                            placeholder="Featured" required="" value="Featured">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang832"
                                                            placeholder="Popular Products" required=""
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang27"
                                                            placeholder="Best Seller" required="" value="Best Seller">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang244"
                                                            placeholder="Flash Deal" required="" value="Flash Deal">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang28"
                                                            placeholder="Top Rated" required="" value="Top Rated">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang29"
                                                            placeholder="Big Save" required="" value="Big Save">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang30"
                                                            placeholder="Hot" required="" value="Hot">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang32"
                                                            placeholder="Trending" required="" value="Trending">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang33"
                                                            placeholder="Sale" required="" value="Sale">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang34"
                                                            placeholder="Read More" required="" value="Read More">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang236"
                                                            placeholder="Brands" required="" value="Brands">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang35"
                                                            placeholder="Tag" required="" value="Tag">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang37"
                                                            placeholder="Archive" required="" value="Archive">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang39"
                                                            placeholder="Blog Details" required="" value="Blog Details">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang40"
                                                            placeholder="View(s)" required="" value="View(s)">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang41"
                                                            placeholder="Source" required="" value="Source">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang43"
                                                            placeholder="Recent Post" required="" value="Recent Post">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang44"
                                                            placeholder="Archives" required="" value="Archives">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang45"
                                                            placeholder="Tags" required="" value="Tags">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang48"
                                                            placeholder="Phone Number" required="" value="Phone Number">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang49"
                                                            placeholder="Email Address" required="" value="Email Address">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang50"
                                                            placeholder="Your Message" required="" value="Your Message">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang51"
                                                            placeholder="Enter Code" required="" value="Enter Code">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang52"
                                                            placeholder="Send Message" required="" value="Send Message">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang53"
                                                            placeholder="Find Us Here" required="" value="Find Us Here">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang54"
                                                            placeholder="Find Us Here" required="" value="Add To Wishlist">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang55"
                                                            placeholder="Quick View" required="" value="Quick View">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang56"
                                                            placeholder="Add To Cart" required="" value="Add To Cart">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang251"
                                                            placeholder="Buy Now" required="" value="Buy Now">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang60"
                                                            placeholder="No Product Found" required=""
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang61"
                                                            placeholder="Filter Results By" required=""
                                                            value="Filter Results By">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang63"
                                                            placeholder="Popular Tags" required="" value="Popular Tags">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang64"
                                                            placeholder="Sort By" required="" value="Sort By">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang65"
                                                            placeholder="Latest Product" required="" value="Latest Product">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang66"
                                                            placeholder="Oldest Product" required="" value="Oldest Product">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang67"
                                                            placeholder="Lowest Price" required="" value="Lowest Price">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang68"
                                                            placeholder="Highest Price" required="" value="Highest Price">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang73"
                                                            placeholder="Rating" required="" value="Rating">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang76"
                                                            placeholder="Remove" required="" value="Remove">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang77"
                                                            placeholder="Product SKU" required="" value="Product SKU">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang78"
                                                            placeholder="Out Of Stock" required="" value="Out Of Stock">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang79"
                                                            placeholder="In Stock" required="" value="In Stock">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang80"
                                                            placeholder="Review(s)" required="" value="Review(s)">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang224"
                                                            placeholder="Add To Favorite Seller" required=""
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang225"
                                                            placeholder="Favorite" required="" value="Favorite">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang81"
                                                            placeholder="Contact Seller" required="" value="Contact Seller">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang82"
                                                            placeholder="Platform" required="" value="Platform">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang83"
                                                            placeholder="Region" required="" value="Region">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang84"
                                                            placeholder="License Type" required="" value="License Type">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang85"
                                                            placeholder="Product Condition" required=""
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang219"
                                                            placeholder="Watch Video" required="" value="Watch Video">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang86"
                                                            placeholder="Estimated Shipping Time" required=""
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang88"
                                                            placeholder="Size" required="" value="Size">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang89"
                                                            placeholder="Color" required="" value="Color">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang91"
                                                            placeholder="SHARE" required="" value="SHARE">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang93"
                                                            placeholder="BUY & RETURN POLICY" required=""
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang94"
                                                            placeholder="Reviews" required="" value="Reviews">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang95"
                                                            placeholder="Comment" required="" value="Comment">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang96"
                                                            placeholder="Ratings & Reviews" required=""
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang97"
                                                            placeholder="No Review Found." required=""
                                                            value="No Review Found.">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang98"
                                                            placeholder="Review" required="" value="Review">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang99"
                                                            placeholder="Your Review" required="" value="Your Review">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang100"
                                                            placeholder="SUBMIT" required="" value="SUBMIT">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang101"
                                                            placeholder="Login" required="" value="Login">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang102"
                                                            placeholder="To Review" required="" value="To Review">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang103"
                                                            placeholder="To Comment" required="" value="To Comment">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang104"
                                                            placeholder="Write Comment" required="" value="Write Comment">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang106"
                                                            placeholder="Post Comment" required="" value="Post Comment">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang107"
                                                            placeholder="Reply" required="" value="Reply">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang108"
                                                            placeholder="View" required="" value="View">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang110"
                                                            placeholder="Replies" required="" value="Replies">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang111"
                                                            placeholder="Edit" required="" value="Edit">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang112"
                                                            placeholder="Delete" required="" value="Delete">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang115"
                                                            placeholder="Cancel" required="" value="Cancel">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang119"
                                                            placeholder="Subject *" required="" value="Subject *">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang199"
                                                            placeholder="Product Quick View" required=""
                                                            value="Product Quick View">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang216"
                                                            placeholder="Related Products" required=""
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang245"
                                                            placeholder="Seller's Products" required=""
                                                            value="Seller's Products">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang246"
                                                            placeholder="Sold By" required="" value="Sold By">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang247"
                                                            placeholder="No Vendor Found" required=""
                                                            value="No Vendor Found">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang248"
                                                            placeholder="Total Item" required="" value="Total Item">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang249"
                                                            placeholder="Visit Store" required="" value="Visit Store">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang770"
                                                            placeholder="Wholesell" required="" value="Wholesell">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang768"
                                                            placeholder="Quantity" required="" value="Quantity">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang769"
                                                            placeholder="Discount" required="" value="Discount">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang771"
                                                            placeholder="Off" required="" value="Off">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang777"
                                                            placeholder="REPORT PRODUCT" required="" value="REPORT PRODUCT">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang778"
                                                            placeholder="Please give the following details" required=""
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang783"
                                                            placeholder="Verified" required="" value="Verified">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang123"
                                                            placeholder="Size & Color" required="" value="Size & Color">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang125"
                                                            placeholder="Unit Price " required="" value="Unit Price">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang126"
                                                            placeholder="Sub Total " required="" value="Sub Total">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang127"
                                                            placeholder="PRICE DETAILS " required="" value="PRICE DETAILS">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang128"
                                                            placeholder="Total MRP " required="" value="Total MRP">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang130"
                                                            placeholder="Your Message " required="" value="Tax">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang132"
                                                            placeholder="Have a promotion code?" required=""
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang133"
                                                            placeholder="Coupon Code" required="" value="Coupon Code">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang134"
                                                            placeholder="Apply" required="" value="Apply">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang135"
                                                            placeholder="Place Order" required="" value="Place Order">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang143"
                                                            placeholder="Shipping Cost" required="" value="Shipping Cost">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang150"
                                                            placeholder="Pick Up" required="" value="Pick Up">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang152"
                                                            placeholder="Full Name" required="" value="Full Name">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang157"
                                                            placeholder="Select Country" required="" value="Select Country">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang159"
                                                            placeholder="Postal Code" required="" value="Postal Code">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang161"
                                                            placeholder="Payment Information" required=""
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang217"
                                                            placeholder="Order Note" required="" value="Order Note">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang218"
                                                            placeholder="Optional" required="" value="Optional">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang162"
                                                            placeholder="Order Now" required="" value="Order Now">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang163"
                                                            placeholder="Card Number" required="" value="Card Number">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang164"
                                                            placeholder="Cvv" required="" value="Cvv">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang165"
                                                            placeholder="Month" required="" value="Month">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang166"
                                                            placeholder="Year e.g. 19" required="" value="Year e.g. 19">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang807"
                                                            placeholder="Card Code" required="" value="Card Code">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang808"
                                                            placeholder="Year e.g. 2038" required="" value="Year e.g. 2038">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang744"
                                                            placeholder="Orders" required="" value="Orders">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang745"
                                                            placeholder="Payment" required="" value="Payment">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang746"
                                                            placeholder="Personal Information" required=""
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang749"
                                                            placeholder="Create an account ?" required=""
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang753"
                                                            placeholder="Continue" required="" value="Continue">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang756"
                                                            placeholder="Total Price" required="" value="Total Price">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang757"
                                                            placeholder="Back" required="" value="Back">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang758"
                                                            placeholder="Shipping Info" required="" value="Shipping Info">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang759"
                                                            placeholder="Payment Info" required="" value="Payment Info">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang760"
                                                            placeholder="PayPal Express" required="" value="PayPal Express">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang761"
                                                            placeholder="Credit Card" required="" value="Credit Card">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang762"
                                                            placeholder="Cash On Delivery" required=""
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang763"
                                                            placeholder="Instamojo" required="" value="Instamojo">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="paytm"
                                                            placeholder="Paytm" required="" value="Paytm">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="razorpay"
                                                            placeholder="Razorpay" required="" value="Razorpay">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang764"
                                                            placeholder="Paystack" required="" value="Paystack">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang802"
                                                            placeholder="Mollie Payment" required="" value="Mollie Payment">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang809"
                                                            placeholder="Authorize.Net" required="" value="Authorize.Net">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang810"
                                                            placeholder="MercadoPago" required="" value="MercadoPago">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang811"
                                                            placeholder="Flutter Wave" required="" value="Flutter Wave">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang812"
                                                            placeholder="2Checkout" required="" value="2Checkout">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang813"
                                                            placeholder="SSLCommerz" required="" value="SSLCommerz">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang814"
                                                            placeholder="Voguepay" required="" value="Voguepay">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang815"
                                                            placeholder="Wallet Amount:" required="" value="Wallet Amount:">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang816"
                                                            placeholder="Pay From Your Wallet" required=""
                                                            value="Pay From Your Wallet">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang766"
                                                            placeholder="Packaging" required="" value="Packaging">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang767"
                                                            placeholder="Final Price" required="" value="Final Price">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang168"
                                                            placeholder="Wishlists" required="" value="Wishlists">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang169"
                                                            placeholder="Success" required="" value="Success">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang170"
                                                            placeholder="Get Back To Our Homepage" required=""
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang171"
                                                            placeholder="Login & Register" required=""
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang172"
                                                            placeholder="LOGIN NOW" required="" value="LOGIN NOW">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang174"
                                                            placeholder="Type Password" required="" value="Type Password">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang175"
                                                            placeholder="Remember Password" required=""
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang176"
                                                            placeholder="Forgot Password?" required=""
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang177"
                                                            placeholder="Authenticating..." required=""
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang234"
                                                            placeholder="Vendor Login" required="" value="Vendor Login">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang180"
                                                            placeholder="Sign In with social media" required=""
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang181"
                                                            placeholder="Signup Now" required="" value="Signup Now">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang188"
                                                            placeholder="Processing..." required="" value="Processing...">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang189"
                                                            placeholder="Register" required="" value="Register">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang235"
                                                            placeholder="Vendor Registration" required=""
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang190"
                                                            placeholder="Forgot Password (Header)" required=""
                                                            value="Forgot Password">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang191"
                                                            placeholder=">Forgot Password (Title)" required=""
                                                            value="Forgot Password ">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang192"
                                                            placeholder="Please Write your Email" required=""
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang195"
                                                            placeholder="Checking..." required="" value="Checking...">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang226"
                                                            placeholder="Store Name" required="" value="Store Name">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang227"
                                                            placeholder="Service Center" required="" value="Service Center">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang228"
                                                            placeholder="Contact Now" required="" value="Contact Now">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang229"
                                                            placeholder="Follow Us" required="" value="Follow Us">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang238"
                                                            placeholder="Shop Name" required="" value="Shop Name">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang239"
                                                            placeholder="Owner Name" required="" value="Owner Name">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang240"
                                                            placeholder="Shop Number" required="" value="Shop Number">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang241"
                                                            placeholder="Shop Address" required="" value="Shop Address">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang21"
                                                            placeholder="Footer Links" required="" value="Footer Links">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field"
                                                            placeholder="Already Added To Cart Message" name="already_cart"
                                                            value="Already Added To Cart" required="">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field"
                                                            ...
                                                            value="Successfully Removed From The Wishlist" required="">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field"
                                                            ...
                                                            value="Successfully Removed From The Compare" required="">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" placeholder="Email Not Found"
                                                            name="email_not_found" value="Email Not Found" required="">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" placeholder="Message Sent !!"
                                                            name="message_sent" value="Message Sent !!" required="">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <div class="tawk-area">
                                                            <textarea name="order_title"
                                                                required="">THANK YOU FOR YOUR PURCHASE.</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field"
                                                            placeholder="Subscribe Success Message" name="subscribe_success"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" placeholder="SUBSCRIBE"
                                                            name="lang742" value="SUBSCRIBE" required="">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" placeholder="404"
                                                            name="lang427" value="404" required="">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-4">
                                                        <div class="left-area">
                                                            <h4 class="heading">The page you are looking for might have been
                                                                moved, renamed, or might
                                                                never existed. *</h4>
                                                            <p class="sub-heading">(In Any Language)</p>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" placeholder="Back Home"
                                                            name="lang430" value="Back Home" required="">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="tab-pane fade" id="nav-profile" role="tabpanel"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang200"
                                                            placeholder="Dashboard" required="" value="Dashboard">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang230"
                                                            placeholder="Vendor Panel" required="" value="Vendor Panel">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang201"
                                                            placeholder="Purchased Items" required=""
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang202"
                                                            placeholder="Affiliate Code" required="" value="Affiliate Code">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang203"
                                                            placeholder="Withdraw" required="" value="Withdraw">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang231"
                                                            placeholder="Favorite Sellers" required=""
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang232"
                                                            placeholder="Messages" required="" value="Messages">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang204"
                                                            placeholder="Tickets" required="" value="Tickets">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang250"
                                                            placeholder="Disputes" required="" value="Disputes">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang205"
                                                            placeholder="Edit Profile" required="" value="Edit Profile">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang206"
                                                            placeholder="Reset Password" required="" value="Reset Password">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang233"
                                                            placeholder="Start Selling" required="" value="Start Selling">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang237"
                                                            placeholder="Pricing Plans" required="" value="Pricing Plans">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang208"
                                                            placeholder="Account Information" required=""
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang211"
                                                            placeholder="Fax" required="" value="Fax">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang213"
                                                            placeholder="Zip" required="" value="Zip">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang215"
                                                            placeholder="Affiliate Bonus" required=""
                                                            value="Affiliate Bonus">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang833"
                                                            placeholder="My Wallet" required="" value="My Wallet">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang834"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang835"
                                                            placeholder="Add Deposit" required="" value="Add Deposit">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang836"
                                                            placeholder="Recent Orders" required="" value="Recent Orders">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang837"
                                                            placeholder="Total Orders" required="" value="Total Orders">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang838"
                                                            placeholder="Pending Orders" required="" value="Pending Orders">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang839"
                                                            placeholder="All Time" required="" value="All Time">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang840"
                                                            placeholder="Transaction ID" required="" value="Transaction ID">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang841"
                                                            placeholder="View Details" required="" value="View Details">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang278"
                                                            placeholder="#Order" required="" value="#Order">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang280"
                                                            placeholder="Order Total" required="" value="Order Total">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang281"
                                                            placeholder="Order Status" required="" value="Order Status">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang283"
                                                            placeholder="VIEW ORDER" required="" value="VIEW ORDER">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang284"
                                                            placeholder="My Order Details" required=""
                                                            value="My Order Details">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang286"
                                                            placeholder="print order" required="" value="Print">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang301"
                                                            placeholder="Order Date" required="" value="Order Date">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang293"
                                                            placeholder="Paid Amount:" required="" value="Paid Amount:">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang295"
                                                            placeholder="Charge ID:" required="" value="Charge ID:">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang297"
                                                            placeholder="Edit Transaction ID" required=""
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang308"
                                                            placeholder="Ordered Products:" required=""
                                                            value="Ordered Products:">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang316"
                                                            placeholder="Download" required="" value="Download">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang317"
                                                            placeholder="View License" required="" value="View License">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang319"
                                                            placeholder="License Key" required="" value="License Key">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang320"
                                                            placeholder="The Licenes Key is :" required=""
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang321"
                                                            placeholder="Close" required="" value="Close">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang322"
                                                            placeholder="Affiliate Informations" required=""
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang323"
                                                            placeholder="Your Affilate Link *" required=""
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang325"
                                                            placeholder="Affiliate Banner *" required=""
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-4">
                                                        <div class="left-area">
                                                            <h4 class="heading">This is your affilate banner html code just
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang329"
                                                            placeholder="My Withdraws" required="" value="My Withdraws">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang330"
                                                            placeholder="Withdraw Now" required="" value="Withdraw Now">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang331"
                                                            placeholder="Withdraw Date" required="" value="Withdraw Date">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang332"
                                                            placeholder="Method" required="" value="Method">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang333"
                                                            placeholder="Account" required="" value="Account">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang335"
                                                            placeholder="Status" required="" value="Status">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang339"
                                                            placeholder="Select Withdraw Method" required=""
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang340"
                                                            placeholder="Paypal" required="" value="Paypal">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang341"
                                                            placeholder="Skrill" required="" value="Skrill">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang342"
                                                            placeholder="Payoneer" required="" value="Payoneer">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang343"
                                                            placeholder="Bank" required="" value="Bank">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang346"
                                                            placeholder="Enter IBAN/Account No" required=""
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang348"
                                                            placeholder="Enter Address" required="" value="Enter Address">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang351"
                                                            placeholder="Withdraw Fee" required="" value="Withdraw Fee">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang772"
                                                            placeholder="Order Tracking" required="" value="Order Tracking">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang773"
                                                            placeholder="Get Tracking Code" required=""
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang774"
                                                            placeholder="View Tracking" required="" value="View Tracking">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang775"
                                                            placeholder="No Order Found" required="" value="No Order Found">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang256"
                                                            placeholder="Actions" required="" value="Actions">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang257"
                                                            placeholder="Confirm Delete" required="" value="Confirm Delete">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang259"
                                                            placeholder="Do you want to proceed?" required=""
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang357"
                                                            placeholder="Compose Message" required=""
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang360"
                                                            placeholder="Sent" required="" value="Sent">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang361"
                                                            placeholder="Action" required="" value="Action">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang368"
                                                            ...
                                                            required="" value="You are about to delete this Conversation.">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang372"
                                                            placeholder="Conversation with" required=""
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang375"
                                                            placeholder="Add Reply" required="" value="Add Reply">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang377"
                                                            placeholder="Add Ticket" required="" value="Add Ticket">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang379"
                                                            placeholder="Add Dispute" required="" value="Add Dispute">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang382"
                                                            placeholder="Time" required="" value="Time">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang386"
                                                            placeholder="Order Number" required="" value="Order Number">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang389"
                                                            placeholder="Send" required="" value="Send">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang263"
                                                            placeholder="Upload" required="" value="Upload">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang271"
                                                            placeholder="Save" required="" value="Save">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang274"
                                                            placeholder="New Password" required="" value="New Password">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang402"
                                                            placeholder="Free" required="" value="Free">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang403"
                                                            placeholder="Day(s)" required="" value="Day(s)">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang404"
                                                            placeholder="Current Plan" required="" value="Current Plan">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang405"
                                                            placeholder="Expired on:" required="" value="Expired on:">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang406"
                                                            placeholder="Ends on:" required="" value="Ends on:">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang407"
                                                            placeholder="Renew" required="" value="Renew">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang408"
                                                            placeholder="Get Started" required="" value="Get Started">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang411"
                                                            placeholder="Plan:" required="" value="Plan:">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang413"
                                                            placeholder="Durations:" required="" value="Durations:">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang414"
                                                            placeholder="Product(s) Allowed:" required=""
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang415"
                                                            placeholder="Note:" required="" value="Note:">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang416"
                                                            ...
                                                            required="" value="Your Previous Plan will be deactivated!">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang421"
                                                            placeholder="Stripe" required="" value="Stripe">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang422"
                                                            placeholder="Card" required="" value="Card">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang819"
                                                            placeholder="Deposit" required="" value="Deposit">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang820"
                                                            placeholder="Transactions" required="" value="Transactions">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang821"
                                                            placeholder="Deposit Now" required="" value="Deposit">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang823"
                                                            placeholder="Deposit Amount" required="" value="Deposit Amount">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang824"
                                                            placeholder="Deposits" required="" value="Deposits">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang825"
                                                            placeholder="Deposit Date" required="" value="Deposit Date">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang827"
                                                            placeholder="Transaction Datee" required=""
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang828"
                                                            placeholder="Details" required="" value="Details">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang517"
                                                            placeholder="(In Any Language)" required=""
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang518"
                                                            placeholder="ADD NEW" required="" value="ADD NEW">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang431"
                                                            placeholder="Welcome!" required="" value="Welcome!">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang436"
                                                            placeholder="New Order(s)." required="" value="New Order(s).">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang437"
                                                            placeholder="Clear All" required="" value="Clear All">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang438"
                                                            placeholder="You Have a new order." required=""
                                                            value="You Have a new order.">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang439"
                                                            placeholder="No New Notifications." required=""
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang441"
                                                            placeholder="Dashbord" required="" value="Dashbord">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang443"
                                                            placeholder="All Orders" required="" value="All Orders">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang444"
                                                            placeholder="Products" required="" value="Products">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang446"
                                                            placeholder="All Products" required="" value="All Products">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang785"
                                                            placeholder="Product Catalogs" required=""
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang447"
                                                            placeholder="Affiliate Products" required=""
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang448"
                                                            placeholder="Add Affiliate Product" required=""
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang449"
                                                            placeholder="All Affiliate Products" required=""
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang450"
                                                            placeholder="Bulk Product Upload" required=""
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang451"
                                                            placeholder="Withdraws" required="" value="Withdraws">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang452"
                                                            placeholder="Settings" required="" value="Settings">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang453"
                                                            placeholder="Services" required="" value="Services">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang454"
                                                            placeholder="Banner" required="" value="Banner">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang456"
                                                            placeholder="Social Links" required="" value="Social Links">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang784"
                                                            placeholder="Verify Account" required="" value="Verify Account">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang463"
                                                            placeholder="Shop Details" required="" value="Shop Details">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang786"
                                                            placeholder="Vendor Verification" required=""
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang788"
                                                            placeholder="Enter Verification Details" required=""
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang789"
                                                            placeholder="Attachment" required="" value="Attachment">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang792"
                                                            placeholder="(Maximum Size is: 10MB)" required=""
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang790"
                                                            placeholder="Add More Attachment" required=""
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang803"
                                                            placeholder="Verify Now " required="" value="Verify Now">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang804"
                                                            placeholder="Your Documents Submitted Successfully." required=""
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang465"
                                                            placeholder="Orders Pending!" required=""
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang466"
                                                            placeholder="Orders Procsessing!" required=""
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang467"
                                                            placeholder="Orders Completed!" required=""
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang469"
                                                            placeholder="Total Item Sold!" required=""
                                                            value="Total Item Sold!">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang470"
                                                            placeholder="Total Earnings!" required=""
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang471"
                                                            placeholder="View All " required="" value="View All ">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang535"
                                                        placeholder="Total Qty" required="" value="Total Qty">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang536"
                                                        placeholder="Total Cost" required="" value="Total Cost">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang537"
                                                        placeholder="Payment Method" required="" value="Payment Method">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang540"
                                                        placeholder="Pending" required="" value="Pending">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang542"
                                                        placeholder="Completed" required="" value="Completed">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang543"
                                                        placeholder="Declined" required="" value="Declined">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang544"
                                                        placeholder="Update Status" required="" value="Update Status">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang545"
                                                        ...
                                                        required="" value="You are about to update the Order's Status.">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang548"
                                                        placeholder="Proceed" required="" value="Proceed">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang549"
                                                        placeholder="Order Details" required="" value="Order Details">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang798"
                                                        placeholder="Payment Status" required="" value="Payment Status">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang799"
                                                        placeholder="Unpaid" required="" value="Unpaid">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang800" placeholder="Paid"
                                                        required="" value="Paid">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang550" placeholder="Back"
                                                        required="" value="Back">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang551"
                                                        placeholder="Order ID" required="" value="Order ID">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang552"
                                                        placeholder="Total Product" required="" value="Total Product">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang554"
                                                        placeholder="Ordered Date" required="" value="Ordered Date">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang555"
                                                        placeholder="View Invoice" required="" value="View Invoice">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang556"
                                                        placeholder="Billing Details" required="" value="Billing Details">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang557"
                                                        placeholder="Customer Name" required="" value="Customer Name">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang562" placeholder="City"
                                                        required="" value="City">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang564"
                                                        placeholder="Shipping Details" required="" value="Shipping Details">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang565"
                                                        placeholder="Pickup Location" required="" value="Pickup Location">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang566"
                                                        placeholder="Products Ordered" required="" value="Products Ordered">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang567"
                                                        placeholder="Product ID#" required="" value="Product ID#">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang572" placeholder="Size"
                                                        required="" value="Size">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang575"
                                                        placeholder="Vendor Removed" required="" value="Vendor Removed">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang576"
                                                        placeholder="Send Email" required="" value="Send Email">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang579"
                                                        placeholder="Enter New License Key" required=""
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang585"
                                                        placeholder="Save License" required="" value="Save License">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang586"
                                                        placeholder="Order Invoice" required="" value="Order Invoice">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang587"
                                                        placeholder="Billing Address" required="" value="Billing Address">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang588"
                                                        placeholder="Invoice Number" required="" value="Invoice Number">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang591"
                                                        placeholder="Product" required="" value="Product">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang592" placeholder="Size"
                                                        required="" value="Size">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang595" placeholder="Qty"
                                                        required="" value="Qty">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang596"
                                                        placeholder="Packaging Cost" required="" value="Packaging Cost">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang597"
                                                        placeholder="Subtotal" required="" value="Subtotal">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang599" placeholder="TAX"
                                                        required="" value="TAX">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang602"
                                                        placeholder="Shipping Method" required="" value="Shipping Method">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang604"
                                                        placeholder="Ship To Address" required="" value="Ship To Address">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang606"
                                                        placeholder="Shipping Address" required="" value="Shipping Address">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang607"
                                                        placeholder="Print Invoice" required="" value="Print Invoice">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang608" placeholder="Name"
                                                        required="" value="Name">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang609" placeholder="Type"
                                                        required="" value="Type">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang713"
                                                        placeholder="Activated" required="" value="Activated">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang714"
                                                        placeholder="Deactivated" required="" value="Deactivated">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang715" placeholder="Edit"
                                                        required="" value="Edit">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang716"
                                                        placeholder="View Gallery" required="" value="View Gallery">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang619"
                                                        placeholder="Image Gallery" required="" value="Image Gallery">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang620"
                                                        placeholder="Upload File" required="" value="Upload File">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang621" placeholder="Done"
                                                        required="" value="Done">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang623"
                                                        placeholder="Add New Product" required="" value="Add New Product">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang624"
                                                        placeholder="No Images Found." required="" value="No Images Found.">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang625"
                                                        placeholder="Product Types" required="" value="Product Types">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang626"
                                                        placeholder="Physical" required="" value="Physical">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang627"
                                                        placeholder="Digital" required="" value="Digital">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang628"
                                                        placeholder="License" required="" value="License">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang629"
                                                        placeholder="Physical Product" required="" value="Physical Product">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang630"
                                                        placeholder="Digital Product" required="" value="Digital Product">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang631"
                                                        placeholder="License Product" required="" value="License Product">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang633"
                                                        placeholder="Allow Product Condition" required=""
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang635" placeholder="New"
                                                        required="" value="New">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang636" placeholder="Used"
                                                        required="" value="Used">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang637"
                                                        placeholder="Category" required="" value="Category">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang691"
                                                        placeholder="Select Category" required="" value="Select Category">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang638"
                                                        placeholder="Sub Category" required="" value="Sub Category">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang640"
                                                        placeholder="Child Category" required="" value="Child Category">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang641"
                                                        placeholder="Select Child Category" required=""
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang642"
                                                        placeholder="Feature Image" required="" value="Feature Image">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang644"
                                                        placeholder="Product Gallery Images" required=""
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang645"
                                                        placeholder="Set Gallery" required="" value="Set Gallery">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang648"
                                                        placeholder="Allow Product Sizes" required=""
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang649"
                                                        placeholder="Size Name" required="" value="Size Name">
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-lg-4">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang650"
                                                        placeholder="(eg. S,M,L,XL,XXL,3XL,4XL)" required=""
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang651"
                                                        placeholder="Size Qty" required="" value="Size Qty">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang653"
                                                        placeholder="Size Price" required="" value="Size Price">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang655"
                                                        placeholder="Add More Size" required="" value="Add More Size">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang656"
                                                        placeholder="Allow Product Colors" required=""
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang657"
                                                        placeholder="Product Colors" required="" value="Product Colors">
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-lg-4">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang659"
                                                        placeholder="Add More Color" required="" value="Add More Color">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang660"
                                                        placeholder="Allow Product Whole Sell" required=""
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang661"
                                                        placeholder="Enter Quantity" required="" value="Enter Quantity">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang663"
                                                        placeholder="Add More Field" required="" value="Add More Field">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang665" placeholder="In"
                                                        required="" value="In">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang666"
                                                        placeholder="e.g 20" required="" value="e.g 20">
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-lg-4">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang667"
                                                        placeholder="Product Previous Price" required=""
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang669"
                                                        placeholder="Product Stock" required="" value="Product Stock">
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-lg-4">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang671"
                                                        placeholder="Allow Product Measurement" required=""
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang672"
                                                        placeholder="Product Measurement" required=""
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang673" placeholder="None"
                                                        required="" value="None">
                                                </div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang674" placeholder="Gram"
                                                        required="" value="Gram">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang675"
                                                        placeholder="Kilogram" required="" value="Kilogram">
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-lg-4">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang676"
                                                        placeholder="Litre" required="" value="Litre">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang677"
                                                        placeholder="Pound" required="" value="Pound">
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-lg-4">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang678"
                                                        placeholder="Custom" required="" value="Custom">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang679"
                                                        placeholder="Enter Unit" required="" value="Enter Unit">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang681"
                                                        placeholder="Product Buy/Return Policy" required=""
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang683"
                                                        placeholder="Allow Product SEO" required=""
                                                        value="Allow Product SEO">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang684"
                                                        placeholder="Meta Tags" required="" value="Meta Tags">
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-lg-4">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang685"
                                                        placeholder="Meta Description" required="" value="Meta Description">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang686"
                                                        placeholder="Feature Tags" required="" value="Feature Tags">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang689" placeholder="Tags"
                                                        required="" value="Tags">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang690"
                                                        placeholder="Create Product" required="" value="Create Product">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang692"
                                                        placeholder="Select Upload Type" required=""
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang693"
                                                        placeholder="Upload By File" required="" value="Upload By File">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang694"
                                                        placeholder="Upload By Link" required="" value="Upload By Link">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang695"
                                                        placeholder="Select File" required="" value="Select File">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang696" placeholder="Link"
                                                        required="" value="Link">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang697"
                                                        placeholder="Product License" required="" value="Product License">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang699"
                                                        placeholder="License Quantity" required="" value="License Quantity">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang701"
                                                        placeholder="Product Platform" required="" value="Product Platform">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang702"
                                                        placeholder="Product Region" required="" value="Product Region">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang704"
                                                        placeholder="Edit Product" required="" value="Edit Product">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang705" placeholder="Edit"
                                                        required="" value="Edit">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang706" placeholder="Save"
                                                        required="" value="Save">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang707"
                                                        placeholder="Product Affiliate Link" required=""
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang708"
                                                        placeholder="(External Link)" required="" value="(External Link)">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang709"
                                                        placeholder="Feature Image Source" required=""
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang710" placeholder="File"
                                                        required="" value="File">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang711" placeholder="Link"
                                                        required="" value="Link">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang712"
                                                        placeholder="Feature Image Link" required=""
                                                        value="Feature Image Link">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang805"
                                                        placeholder="Prefered Size: (800x800) or Square Size." required=""
                                                        value="Prefered Size: (800x800) or Square Size.">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang806"
                                                        placeholder="Image height and width must be 600 x 600." required=""
                                                        value="Image height and width must be 600 x 600.">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang807"
                                                        placeholder="Image must have square size." required=""
                                                        value="Image must have square size.">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang531"
                                                        placeholder="Download Sample CSV" required=""
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang532"
                                                        placeholder="Upload a File" required="" value="Upload a File">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang533"
                                                        placeholder="Start Import" required="" value="Start Import">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang480" placeholder="Back"
                                                        required="" value="Back">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang481"
                                                        placeholder="Withdraw Method" required="" value="Withdraw Method">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang486" placeholder="Bank"
                                                        required="" value="Bank">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang487"
                                                        placeholder="Withdraw Amount" required="" value="Withdraw Amount">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang492"
                                                        placeholder="Enter Swift Code" required="" value="Enter Swift Code">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang495" placeholder="and"
                                                        required="" value="and">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang498"
                                                        placeholder="Current Balance" required="" value="Current Balance">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang499"
                                                        placeholder="SERVICE" required="" value="SERVICE">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang500"
                                                        placeholder="Featured Image" required="" value="Featured Image">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang717" placeholder="Edit"
                                                        required="" value="Edit">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang509"
                                                        placeholder="Add New Service" required="" value="Add New Service">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang511"
                                                        placeholder="Current Featured Image" required=""
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang512"
                                                        placeholder="Upload Image" required="" value="Upload Image">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-4">
                                                    <div class="left-area">
                                                        <h4 class="heading">Prefered Size: (600x600) or Square Sized Image *
                                                        </h4>
                                                        <p class="sub-heading">(In Any Language)</p>
                                                    </div>
                                                </div>
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang513"
                                                        ...
                                                        required="" value="Prefered Size: (600x600) or Square Sized Image">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang515"
                                                        placeholder="Create Service" required="" value="Create Service">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang516" placeholder="Save"
                                                        required="" value="Save">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang719"
                                                        placeholder="Shipping Methods" required="" value="Shipping Methods">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang721"
                                                        placeholder="Packagings" required="" value="Packagings">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang725" placeholder="Edit"
                                                        required="" value="Edit">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-4">
                                                    <div class="left-area">
                                                        <h4 class="heading">You are about to delete this Shipping Method. *
                                                        </h4>
                                                        <p class="sub-heading">(In Any Language)</p>
                                                    </div>
                                                </div>
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang727"
                                                        ...
                                                        required="" value="You are about to delete this Shipping Method.">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang732"
                                                        placeholder="Add New Shipping Method" required=""
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang733"
                                                        placeholder="Add New Packaging" required=""
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang736"
                                                        placeholder="Subtitle" required="" value="Subtitle">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang737"
                                                        placeholder="Duration" required="" value="Duration">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang739"
                                                        placeholder="Create" required="" value="Create">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang740" placeholder="Save"
                                                        required="" value="Save">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang520"
                                                        placeholder="Current Banner" required="" value="Current Banner">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-4">
                                                    <div class="left-area">
                                                        <h4 class="heading">Prefered Size: (1920x220) or Relevant Sized
                                                            Image *</h4>
                                                        <p class="sub-heading">(In Any Language)</p>
                                                    </div>
                                                </div>
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang521"
                                                        placeholder="Prefered Size: (1920x220) or Relevant Sized Image"
                                                        required=""
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang522"
                                                        placeholder="Upload Banner" required="" value="Upload Banner">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang523" placeholder="Save"
                                                        required="" value="Save">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang525" placeholder="Save"
                                                        required="" value="Save">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang527"
                                                        placeholder="Google Plus" required="" value="Google Plus">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang528"
                                                        placeholder="Twitter" required="" value="Twitter">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field" name="lang530" placeholder="Save"
                                                        required="" value="Save">
                                                </div>
                                            </div>
