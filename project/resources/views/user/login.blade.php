              ...
              <div class="login-form signin-form">
                ...
                <form class="mloginform" action="{{ route('user.login.submit') }}" method="POST">
                  ...
                  <div class="form-input">
                    <input type="email" name="email" id="email_login" placeholder="{{ $langg->lang173 }}" required="">
                    <i class="icofont-user-alt-5"></i>
                  </div>
                  <div class="form-input">
                    <input type="password" class="Password" id="password_login" name="password" placeholder="{{ $langg->lang174 }}"
                      required="">
